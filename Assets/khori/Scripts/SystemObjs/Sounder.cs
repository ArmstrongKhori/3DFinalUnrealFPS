...
// !!! <-- "https://youtu.be/mbJBnzjJG6g" ... Just a note for the future.
...
public class Sounder : SystemObj {
    ...
    public SoundFX[] audioBuffer = new SoundFX[BUFFERCOUNT];
    ...
    {
        SoundFX sfx = audioBuffer[audioIndex];
    ...
    internal override void Initialize()
    {
        ...
        for (int i = 0; i < audioBuffer.Length; i++)
        {
            ...
            SoundFX sfx = go.AddComponent<SoundFX>();
            audioBuffer[i] = sfx;
        }
    }
